...
class AZUREUTIL(object):
    ...
    def is_blob_exists(file_name, container_name):
        try:
            ...
            UTIL.append_log_line("Error : AZUREUTIL.is_blob_exists_____" + container_name + "__" + file_name + "_____" + str(e))
    ...
    def get_file(file_name, container_name):
        try:
            ...
            UTIL.append_log_line("Error : AZUREUTIL.get_file_____" + container_name + "__" + file_name + str(e))
            raise Exception("Error : AZUREUTIL.get_file_____") from e
    ...
    def save_file(file_name, container_name, to_delete=True):
        try:
            ...
            UTIL.append_log_line("Error : AZUREUTIL.save_file_____" + str(e))
